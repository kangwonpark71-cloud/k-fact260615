...
> = {
  ...
  social: {
    label: "SNS",
    color: "text-sky-400",
    bg: "bg-sky-400/15 border-sky-400/30",
    Icon: Hash,
  },
};
    ...
    <div className="glass rounded-2xl overflow-hidden flex flex-col shadow-[var(--shadow-card)]">
      ...
      <div className={`xl:contents ${mobileExpanded ? "contents" : "hidden xl:contents"}`}>
        ...
        <div
          ...
          style={{
            maxHeight: listMaxHeight ?? "calc(100vh - 280px)",
            minHeight: listMinHeight ?? "400px",
          }}
        >
          {isLoading && (
                    ...
                    <div className="flex gap-3 items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2 sm:mt-1.5 flex-wrap">
                          <span
                            className={`inline-flex items-center gap-1 px-2 sm:px-1.5 py-1 sm:py-0.5 rounded border text-xs sm:text-[10px] font-medium ${meta.bg} ${meta.color}`}
                          >
